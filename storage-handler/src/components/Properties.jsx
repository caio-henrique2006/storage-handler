...
export default function Properties({
  ...
  return (
    <div className="Properties">
      ...
      <div>
        {isOpen_Delete ? (
          <Delete id={id} reLoad={reLoad} setIsOpen_Delete={setIsOpen_Delete} />
        ) : null}
      </div>
      <div>
        {isOpen_delete_historic ? (
          <Delete_historic
            id={id}
            reLoad={reLoad}
            storage={storage}
      ...
      <div>
        <p className="Properties_historic">
          <b>Histórico:</b>{" "}
        </p>
        <div
          className="Delete_false"
          style={{ width: 28, height: 28, float: "right" }}
          onClick={() => {
      ...
      <div className="Properties_historic_content">
        <Historic id={id} loadValue={loadValue} />
      </div>
    </div>
  );
}
